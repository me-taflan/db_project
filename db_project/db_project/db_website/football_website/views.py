...
class PlayerData:
    def __init__(self,id,player_api_id,player_name,player_fifa_api_id,birthday,height,weight,rating):
        self.id=id
...
def fav_page(request,username):
    match_select_query='''SELECT matches.*
                            FROM matches
                            JOIN favorite_matches ON matches.id = favorite_matches.match_id
